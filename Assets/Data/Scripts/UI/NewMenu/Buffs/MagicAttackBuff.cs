...
[CreateAssetMenu(menuName = "Item Effects/Magic Attack Buff")]
public class MagicAttackBuff : UsableItemEffect {
    ...
    public override void ExecuteEffect(UsableItem parentItem, Player player) {
        if (buff != 0) {
            ...
            player.MagicAttack.AddModifier(statModifier);
    ...
    public override string GetDescription() {
        if (buff != 0)
            return "Grants " + buff + " Magic Attack for " + Duration + " seconds.";
        return " ";
    }
