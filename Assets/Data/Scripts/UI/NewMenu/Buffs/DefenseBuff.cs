...
[CreateAssetMenu(menuName = "Item Effects/Defense Buff")]
public class DefenseBuff : UsableItemEffect {
    ...
    public override void ExecuteEffect(UsableItem parentItem, Player player) {
        if (buff != 0) {
            ...
            player.Defense.AddModifier(statModifier);
    ...
    public override string GetDescription() {
        if (buff != 0)
            return "Grants " + buff + " Defense for " + Duration + " seconds.";
        return " ";
    }
